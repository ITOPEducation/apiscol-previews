...
REM ********************************************************
REM allways call firefox
REM if not exist "%SLIMERJSLAUNCHER%" (
REM     if exist "%SLIMERDIR%\xulrunner\xulrunner.exe" (
REM         SET SLIMERJSLAUNCHER="%SLIMERDIR%\xulrunner\xulrunner.exe"
REM     )
REM )
...
:callexec
echo "Lancement exécutable %SLIMERJSLAUNCHER%"
if ["%HIDE_ERRORS%"]==[""] (
